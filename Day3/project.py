...
direction = input("The road is narrow and windy through the thick jungle, suddenly you reach a crossroad, where do you want to go, left or right? ").lower()

if direction == "left":
    # Continue in game
    swim = input("You approach lake at high tide, do you want to swim or wait? ").lower()
    if swim == "wait":    
